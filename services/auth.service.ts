...
export async function changeAvatar(userId: string, fileBuffer: Buffer, mimeType: string) {
...
export async function updateConfigProfile(userId: string, form: Partial<Profile>): Promise<boolean>{
